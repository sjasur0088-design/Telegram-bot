...
TXT["ru"].update({
    ...
    "physical_border":"🚧 Пограничные посты",
    "physical_ved":"📦 ВЭД посты",
    "physical_location":"📍 Локация",
    "physical_ai_intro":"🤖 AI таможенник\n\nБыстрые ответы по таможенным вопросам для физических лиц.\n\nВыберите вариант:",
    "physical_ready_pick":"Выберите готовый вопрос:",
    "physical_posts_pick":"Выберите тип постов:",
    "physical_posts_enter_number":"Отправьте номер поста из списка.",
    "physical_posts_not_found":"Пост не найден. Отправьте номер из списка.",
    "physical_no_location":"❌ Геолокация для этого поста пока не указана.",
    "physical_ask":"Напишите ваш вопрос по таможенным правилам для физлиц.",
})
TXT["uz"].update({
    ...
    "physical_border":"🚧 Chegara postlari",
    "physical_ved":"📦 VED postlari",
    "physical_location":"📍 Lokatsiya",
    "physical_ai_intro":"🤖 AI bojxonachi\n\nJismoniy shaxslar uchun bojxona savollariga tezkor javob.\n\nVariantni tanlang:",
    "physical_ready_pick":"Tayyor savolni tanlang:",
    "physical_posts_pick":"Post turini tanlang:",
    "physical_posts_enter_number":"Ro‘yxatdan post raqamini yuboring.",
    "physical_posts_not_found":"Post topilmadi. Ro‘yxatdagi raqamni yuboring.",
    "physical_no_location":"❌ Bu post uchun geolokatsiya hali ko‘rsatilmagan.",
    "physical_ask":"Jismoniy shaxslar uchun bojxona qoidalari bo‘yicha savolingizni yozing.",
})

PHYSICAL_FAQ = {
    "ru": {
        "Таможенные правила для физлиц": "Через международные аэропорты можно ввозить товары без таможенных платежей до 2000 долларов США, через железнодорожные и речные пункты — до 1000 долларов США, через автодорожные и пешеходные пункты — до 300 долларов США. Алкоголь — до 2 литров, табачные изделия — до 10 пачек, духи и туалетная вода — до 3 единиц, ювелирные изделия — до 65 граммов. Если нужна точная проверка по вашему случаю — нажмите «Специалист».",
        "Сколько можно ввозить без пошлины": "Без пошлины можно ввозить товары в пределах установленной нормы: аэропорт — до 2000 USD, железнодорожные и речные пункты — до 1000 USD, автодорожные и пешеходные пункты — до 300 USD. Если лимит превышен, применяются платежи только к превышению. Если нужна точная проверка — нажмите «Специалист».",
        "Сколько телефонов можно привезти": "Для физических лиц телефонный аппарат обычно рассматривается в пределах количественной нормы 1 единица в 6 календарных месяцев через автодорожные, пешеходные, железнодорожные и речные пункты. Если количество больше или ввоз регулярный, это могут оценить как коммерческий ввоз. Если нужна точная проверка — нажмите «Специалист».",
        "Можно ли ввозить лекарства": "Лекарства можно ввозить, но важны состав, количество и назначение. По отдельным препаратам могут требоваться подтверждающие документы или дополнительные разрешения. Напишите название препарата и количество, если хотите уточнить. Также можно нажать «Специалист».",
        "Сколько можно вывозить валюты": "Физические лица могут вывозить наличную валюту за пределы Узбекистана в сумме, не превышающей эквивалент 100 миллионов сумов. Если нужна точная проверка по вашей ситуации — нажмите «Специалист».",
        "Что будет при превышении нормы": "При превышении предельных норм для физлиц применяется единый таможенный платеж: 30% от таможенной стоимости, но не менее 3 долларов США за килограмм — в части превышения нормы. Если нужна точная проверка — нажмите «Специалист».",
    },
    "uz": {
        "Jismoniy shaxslar uchun bojxona qoidalari": "Xalqaro aeroportlar orqali 2000 AQSH dollarigacha, temir yo‘l va daryo punktlari orqali 1000 AQSH dollarigacha, avtoyo‘l va piyoda punktlari orqali 300 AQSH dollarigacha bojsiz olib kirish mumkin. Alkogol — 2 litrgacha, tamaki — 10 pachkagacha, atir va tualet suvi — 3 donagacha, zargarlik buyumlari — 65 grammgacha. Aniq tekshiruv kerak bo‘lsa — «Mutaxassis» tugmasini bosing.",
        "Bojsiz qancha olib kirish mumkin": "Bojsiz olib kirish me’yori: aeroport orqali 2000 USDgacha, temir yo‘l va daryo punktlari orqali 1000 USDgacha, avtoyo‘l va piyoda punktlari orqali 300 USDgacha. Limit oshsa, to‘lov faqat oshgan qismga qo‘llanadi. Aniq tekshiruv kerak bo‘lsa — «Mutaxassis» tugmasini bosing.",
        "Nechta telefon olib kirish mumkin": "Jismoniy shaxslar uchun telefon apparati odatda 6 kalendar oyda 1 dona miqdoriy norma doirasida ko‘riladi. Agar soni ko‘p bo‘lsa yoki tez-tez olib kirilsa, bu tijorat importi deb baholanishi mumkin. Aniq tekshiruv uchun «Mutaxassis» tugmasini bosing.",
        "Dori olib kirish mumkinmi": "Dori vositalarini olib kirish mumkin, lekin tarkibi, miqdori va maqsadi muhim. Ayrim dorilar bo‘yicha qo‘shimcha hujjatlar yoki ruxsat talab qilinishi mumkin. Dori nomi va miqdorini yozib aniqlashtirishingiz mumkin. Yoki «Mutaxassis» tugmasini bosing.",
        "Qancha valyuta olib chiqish mumkin": "Jismoniy shaxslar O‘zbekistondan naqd valyutani 100 million so‘m ekvivalentidan oshmagan miqdorda olib chiqishlari mumkin. Aniq holat bo‘yicha tekshiruv kerak bo‘lsa — «Mutaxassis» tugmasini bosing.",
        "Norma oshsa nima bo‘ladi": "Jismoniy shaxslar uchun me’yor oshsa, oshgan qismga yagona bojxona to‘lovi qo‘llanadi: bojxona qiymatining 30 foizi, lekin kamida 3 USD/kg. Aniq tekshiruv uchun «Mutaxassis» tugmasini bosing.",
    }
}

PHYSICAL_BORDER_POSTS = [
  {
    "num": 1,
    "code": "101",
...
PHYSICAL_VED_POSTS = [
  {
    ...
    "code": "102",
    "name": "\"Авиа юклар\" ТИФ",
    "info": "Тошкент, шаҳар, Сирғали тумани, \"Ислом Каримов номидаги “Тошкент” халқаро аэропорти\" худудида",
    "contact": "+99855 502-86-43",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "3011",
    "name": "\"Андижон\" ТИФ",
    "info": "Андижон шаҳар, АЮлдашев кўчаси, 55 уй",
    "contact": "998742247615 (6570,6571,6572,6573)",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "3015",
    "name": "\"Асака\" ТИФ",
    "info": "Андижон вилояти, Асака шаҳар, ЖМангуберди кўчаси, 36 “а”- уй",
    "contact": "998742247615 (6580,6581,6582,6583, 6584)",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "6006",
    "name": "\"Бухоро\" ТИФ",
    "info": "Бухоро вилояти, Бухоро шахар, Саноатчилар кўчаси 2 уй",
    "contact": "998 65 225 38 30",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "6009",
    "name": "\"Қоракўл\" ТИФ",
    "info": "Бухоро вилояти, Қоракўл туман. Бухоро кўчаси 9-уй",
    "contact": "998 95 600 99 50",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "8004",
    "name": "\"Жизах\" ТИФ",
    "info": "Жиззах вилояти, Жиззах шаҳар, \"А\" саноат худуди, 10 уй",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "10002",
    "name": "\"Насаф\" ТИФ",
    "info": "Қашқадарё вилояти Қарши шахар Ёг завод кучаси 2 уй",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "info": "Қашқадарё вилояти, Ғузор тумани, А-380 йўли яқинида, Шўртан қўрғони",
    "contact": "998752211418(8524,8527)",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "12003",
    "name": "\"Навоий\" ТИФ",
    "info": "Навоий вилояти, Навоий шаҳар, Навоий кўчаси 5-уй",
    "contact": "+998(79)-229-28-00",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "12008",
    "name": "\"Зарафшон\" ТИФ",
    "info": "Навоий вилояти, Зарафшон шаҳар, шаҳарга кириш ҳудуди",
    "contact": "+998(79)-573-43-68",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "14010",
    "name": "\"Наманган\" ТИФ",
    "info": "Namangan viloyati, Namangan shahri, Yuqori Rovuston ko`chasi.",
    "contact": "998692267600 (6971, 6972)",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "18005",
    "name": "\"Самарқанд\" ТИФ",
    "info": "Самарқанд вилояти, Самарканд тумани Ўзбеккент маҳалласи",
    "contact": "-",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "18007",
    "name": "\"Улуғбек\" ТИФ",
    "info": "Самарқанд вилояти, Пастдарғом тумани Чархин қўрғони",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "22005",
    "name": "\"Термиз\" ТИФ",
    "info": "Сурхондарё вилояти, Термиз тумани, Айритом махалласи",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "22006",
    "name": "\"Денов\" ТИФ",
    "info": "Сурхондарё вилояти, Денов шахри, Фаррухий кўчаси 2 уй",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "24009",
    "name": "\"Гулистон\" ТИФ",
    "info": "Сирдарё вилояти, Гулистон шахри, Аноров кўчаси 1-уй",
    "contact": "ички номер (6787; 6788)",
    "lat": null,
    "lon": null
  },
  {
    ...
    "info": "Тошкент шаҳар, Яшнобод тумани, Фарғона йўли кўчаси, 13/11-уй",
    "contact": "71-207-09-72",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "26003",
    "name": "\"Арқбулоқ\" ТИФ",
    "info": "Тошкент вилояти, Зангиота тумани, Эркин ҚФЙ, Тариқ тешар маҳалласи",
    "contact": "71-207-09-40",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "26004",
    "name": "\"Чуқурсой\" ТИФ",
    "info": "Тошкент шаҳар, Олмазор тумани, Чуқурсой кўчаси 92Б уй",
    "contact": "71-207-09-74",
    "lat": null,
    "lon": null
  },
  {
    ...
    "info": "Тошкент шаҳар, Сирғали тумани, Суғдиёна кўчаси 3-уй",
    "contact": "71-207-08-52",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "27014",
    "name": "\"Чирчиқ\" ТИФ",
    "info": "Тошкент вилояти, Чирчиқ шаҳри, Рамазон кўчаси 52 уй",
    "contact": "99871-202-07-61",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "27015",
    "name": "\"Олмалиқ\" ТИФ",
    "info": "Тошкент вилояти, Олмалиқ шаҳар, Фахрийлар кўчаси, 29 уй",
    "contact": "99871-202-02-80",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "27016",
    "name": "\"Янгийўл\" ТИФ",
    "info": "Тошкент вилояти, Зангиота тумани, Ўртаоул МФЙ, Файз маҳалласи",
    "contact": "99871-202-02-82",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "27019",
    "name": "\"Назарбек\" ТИФ",
    "info": "Тошкент вилояти, Зангиота тум., Назарбек қфй, Лойихачи кўча 11",
    "contact": "99878-150-88-56",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "27020",
    "name": "\"Келес\" ТИФ",
    "info": "Тошкент вилояти, Тошкент тум., Оқибат кўчаси 140 уй",
    "contact": "99871-202-02-77",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "27028",
    "name": "\"Ангрен\" ТИФ",
    "info": "Тошкент вилояти, Ангрен шаҳри, Саноат ҳудуди, Ипак-йўли кўчаси 1 уй,",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "30002",
    "name": "\"Қўқон\" ТИФ",
    "info": "Фарғона вилояти, Қўқон шаҳар, Шохрухобод кўчаси 2-уй",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "30009",
    "name": "\"Водий\" ТИФ",
    "info": "Фарғона вилояти, Фарғона шаҳар, Ёруғлик кўчаси 19-уй",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "33007",
    "name": "\"Урганч\" ТИФ",
    "info": "Хоразм вилояти, Урганч шаҳар “Хонқа” кўчаси 62/1-уй",
    "contact": "",
    "lat": null,
    "lon": null
  },
  {
    ...
    "code": "35002",
    "name": "\"Нукус\" ТИФ",
    "info": "Нукус шаҳри, Қиз кеткен МФЙ Жанубий саноат зонаси рақамсиз уй (“Умид Нукус” МЧЖ маъмурий биносида)",
    "contact": "+998 (61) 224-95-59",
    "lat": null,
    "lon": null
  },
  {
    ...
    "info": "Тошкент шаҳар, Сирғали тумани, Қумариқ кўчаси 102-уй",
    "contact": "71-207-14-03",
    "lat": null,
    "lon": null
  },
  {
    ...
    "info": "Сурхондарё вилояти, Термиз тумани, \"Айритом\" МФЙ",
    "contact": "998762299595, (8895)",
    "lat": null,
    "lon": null
  }
]
...
def physical_ready_kb(lang: str):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    for q in PHYSICAL_FAQ[lang].keys():
        kb.add(q)
    kb.add(t(lang, "back"), t(lang, "specialist"))
    kb.add(t(lang, "back_menu"))
    return kb
...
def physical_posts_menu_kb(lang: str):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    kb.add(t(lang, "physical_border"), t(lang, "physical_ved"))
    kb.add(t(lang, "back"), t(lang, "back_menu"))
    return kb

def physical_post_detail_kb(lang: str, has_location: bool = False):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    if has_location:
...
def build_posts_list(posts, lang: str) -> str:
    title = "Список таможенных постов" if lang == "ru" else "Bojxona postlari ro‘yxati"
    lines = [f"<b>{title}</b>"]
    for p in posts:
        lines.append(f"{p['num']}. {p['name']}")
    lines.append("")
    lines.append(t(lang, "physical_posts_enter_number"))
    return "\n".join(lines)

def find_post_by_number(posts, value: str):
    norm = normalize_text(value)
    digits = re.sub(r"\D", "", norm)
    for p in posts:
        if str(p.get("num")) == digits:
            return p
    return None

def post_has_location(post: Dict[str, Any]) -> bool:
    try:
        return post.get("lat") is not None and post.get("lon") is not None
    except Exception:
        return False

def format_post_card(post: Dict[str, Any], lang: str) -> str:
    number_label = "№" if lang == "ru" else "№"
    code_label = "Код поста" if lang == "ru" else "Post kodi"
    info_label = "Информация" if lang == "ru" else "Ma’lumot"
    location_label = "Локация" if lang == "ru" else "Lokatsiya"
    contact_label = "Контакт" if lang == "ru" else "Kontakt"
    title = escape(str(post.get("name", "")))
    parts = [f"<b>{number_label} {post.get('num')}</b>", f"<b>{title}</b>"]
    if post.get("code"):
        parts.append(f"<b>{code_label}:</b> <code>{escape(str(post.get('code')))}</code>")
    if post.get("info"):
        parts.append(f"<b>{info_label}:</b> {escape(str(post.get('info')))}")
    if post.get("contact"):
        parts.append(f"<b>{contact_label}:</b> {escape(str(post.get('contact')))}")
    if post_has_location(post):
        parts.append(f"<b>{location_label}:</b> {post.get('lat')}, {post.get('lon')}")
    return "\n".join(parts)

async def answer_physical_ai(message: types.Message, uid: int, text: str):
    c = ctx(uid)
    lang = c["lang"]
    if text in PHYSICAL_FAQ[lang]:
        await message.answer(PHYSICAL_FAQ[lang][text], reply_markup=physical_ready_kb(lang))
        return

    if not looks_like_customs_question(text):
        await message.answer(t(lang, "only_customs"), reply_markup=physical_menu(lang))
        return

    answer = physical_answer(text, lang)

    if client:
        try:
            prompt = (
                ("Ты помощник по таможенным вопросам для физических лиц в Узбекистане. "
                 "Отвечай кратко и по делу только по теме таможни. "
                 "Если не уверен — прямо скажи, что нужна проверка специалиста. "
                 "В конце предложи обратиться к специалисту.\n\nВопрос: ")
                + text
            )
            resp = client.responses.create(model=OPENAI_MODEL, input=prompt)
            ai_text = (getattr(resp, "output_text", "") or "").strip()
            if ai_text:
                answer = ai_text
        except Exception:
            pass

    if lang == "ru" and "специалист" not in answer.lower():
        answer += "\n\nТочную информацию по вашему кейсу можно получить бесплатно через специалиста."
    if lang == "uz" and "mutaxassis" not in answer.lower():
        answer += "\n\nAniq ma’lumotni mutaxassis orqali bepul olishingiz mumkin."

    await send_safe_message(message, answer, reply_markup=physical_menu(lang))
...
# physical_menu overridden above for physical persons section
...
async def router(message: types.Message):
    ...
    if text == t(lang, "back"):
        ...
        if c["mode"] == "legal_item":
            ...
            return
        if c["mode"] == "physical_ready_faq":
            c["mode"] = "physical_ai_menu"
            await message.answer(t(lang, "physical_ai_intro"), reply_markup=physical_ai_kb(lang))
            return
        if c["mode"] == "physical_post_detail":
            prev = c.get("form_data", {}).get("posts_prev_mode")
            if prev == "physical_posts_ved":
                c["mode"] = "physical_posts_ved"
                await send_safe_message(message, build_posts_list(PHYSICAL_VED_POSTS, lang), reply_markup=physical_posts_menu_kb(lang))
                return
            c["mode"] = "physical_posts_border"
            await send_safe_message(message, build_posts_list(PHYSICAL_BORDER_POSTS, lang), reply_markup=physical_posts_menu_kb(lang))
            return
        if c["mode"] in ["physical_posts_border", "physical_posts_ved"]:
            c["mode"] = "physical_posts_menu"
            await message.answer(t(lang, "physical_posts_pick"), reply_markup=physical_posts_menu_kb(lang))
            return
        if c["mode"] in ["physical_ai_menu", "physical_ai_chat", "physical_posts_menu"]:
            await send_role_menu(message, uid)
            return
        await send_role_menu(message, uid)
        return
    ...
    if role == "physical":
        ...
        if text == t(lang, "physical_ready"):
            c["mode"] = "physical_ready_faq"
            await message.answer(t(lang, "physical_ready_pick"), reply_markup=physical_ready_kb(lang)); return
        if text == t(lang, "physical_own"):
            c["mode"] = "physical_ai_chat"
            await message.answer(t(lang, "physical_ask"), reply_markup=physical_menu(lang)); return
        if text == t(lang, "physical_posts"):
            reset_mode(uid); c["mode"] = "physical_posts_menu"
            await message.answer(t(lang, "physical_posts_pick"), reply_markup=physical_posts_menu_kb(lang)); return
        if text == t(lang, "physical_border"):
            c["mode"] = "physical_posts_border"
            await send_safe_message(message, build_posts_list(PHYSICAL_BORDER_POSTS, lang), reply_markup=physical_posts_menu_kb(lang)); return
        if text == t(lang, "physical_ved"):
            c["mode"] = "physical_posts_ved"
            await send_safe_message(message, build_posts_list(PHYSICAL_VED_POSTS, lang), reply_markup=physical_posts_menu_kb(lang)); return
        if c["mode"] == "physical_ready_faq" and text in PHYSICAL_FAQ[lang]:
            await message.answer(PHYSICAL_FAQ[lang][text], reply_markup=physical_ready_kb(lang)); return
        if c["mode"] in ["physical_ai_menu", "physical_ai_chat", "physical_ready_faq"] and looks_like_customs_question(text):
            await answer_physical_ai(message, uid, text); return
        if c["mode"] in ["physical_posts_border", "physical_posts_ved"]:
            posts = PHYSICAL_BORDER_POSTS if c["mode"] == "physical_posts_border" else PHYSICAL_VED_POSTS
            post = find_post_by_number(posts, text)
            if post:
                c["form_data"]["selected_post"] = post
                c["form_data"]["posts_prev_mode"] = c["mode"]
                c["mode"] = "physical_post_detail"
                await send_safe_message(message, format_post_card(post, lang), reply_markup=physical_post_detail_kb(lang, post_has_location(post))); return
            await message.answer(t(lang, "physical_posts_not_found"), reply_markup=physical_posts_menu_kb(lang)); return
        if c["mode"] == "physical_post_detail" and text == t(lang, "physical_location"):
            post = c.get("form_data", {{}}).get("selected_post")
            if post and post_has_location(post):
                await bot.send_location(message.chat.id, float(post["lat"]), float(post["lon"]))
                await message.answer(format_post_card(post, lang), reply_markup=physical_post_detail_kb(lang, True)); return
            await message.answer(t(lang, "physical_no_location"), reply_markup=physical_post_detail_kb(lang, False)); return
