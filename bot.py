...
PHYSICAL_FAQ = {
    "ru": {
        "Таможенные правила для физлиц": (
            ...
            "Через аэропорты лимиты обычно выше, чем через автодорожные пункты. "
            "Также есть отдельные ограничения по алкоголю, табачным изделиям, парфюмерии и некоторым другим товарам.
...
"
        ...
        "Сколько телефонов можно привезти": (
            ...
            "Если это 1 телефон для себя, ситуация обычно проще. Если телефонов несколько, таможня может расценить это как не для личного пользования.
...
"
        ...
        "Можно ли ввозить лекарства": (
            ...
            "По отдельным препаратам могут быть ограничения.
