...
PHYSICAL_CUSTOMS_CONTEXT = 'Если Вы въезжаете в Узбекистан, для физлиц действуют лимиты беспошлинного ввоза: через аэропорты до 2000 USD, через железнодорожные и речные пункты до 1000 USD, через автодорожные и пешеходные пункты до 300 USD. Отдельные нормы: алкоголь до 2 литров, табачные изделия до 10 пачек, духи и туалетная вода до 3 единиц, ювелирные изделия до 65 граммов. При превышении нормы применяется единый таможенный платеж 30% от таможенной стоимости, но не менее 3 USD/кг. Телефонный аппарат, компьютерная техника, планшет, ноутбук и часть бытовой техники через автодорожные, пешеходные, железнодорожные и речные пункты — обычно 1 единица в 6 календарных месяцев. Вывоз наличной валюты физлицами возможен в сумме, не превышающей эквивалент 100 миллионов сумов.'

PHYSICAL_READY_ANSWERS = {
    "ru": {
        "Таможенные правила для физлиц": "Для физических лиц при въезде в Узбекистан действуют нормы беспошлинного ввоза. Через международные аэропорты можно ввозить товары до 2000 долларов США, через железнодорожные и речные пункты — до 1000 долларов США, через автодорожные и пешеходные пункты — до 300 долларов США. По отдельным товарам действуют специальные количественные ограничения.",
        "Сколько можно ввозить без пошлины": "Без уплаты таможенных платежей можно ввозить товары в пределах нормы: до 2000 USD через аэропорты, до 1000 USD через железнодорожные и речные пункты, до 300 USD через автодорожные и пешеходные пункты.",
        "Сколько телефонов можно привезти": "Для физлиц телефонный аппарат обычно рассматривается в количественной норме 1 единица в 6 календарных месяцев через автодорожные, пешеходные, железнодорожные и речные пункты. Если количество больше или ввоз выглядит регулярным, это могут оценить как коммерческий ввоз.",
        "Можно ли ввозить лекарства": "Лекарства можно ввозить, но нужно учитывать состав, количество, назначение и возможные ограничения по отдельным веществам. Для точного ответа лучше написать название препарата и количество.",
        ...
        "Что будет при превышении нормы": "Если норма беспошлинного ввоза превышена, применяется единый таможенный платеж: 30% от таможенной стоимости, но не менее 3 долларов США за кг, в части превышения нормы."
    },
    "uz": {
        "Jismoniy shaxslar uchun bojxona qoidalari": "Jismoniy shaxslar uchun O‘zbekistonga kirishda bojsiz olib kirish me’yorlari mavjud. Aeroportlar orqali 2000 AQSH dollarigacha, temir yo‘l va daryo punktlari orqali 1000 AQSH dollarigacha, avtoyo‘l va piyoda punktlari orqali 300 AQSH dollarigacha. Ayrim tovarlar uchun alohida miqdoriy cheklovlar ham bor.",
        ...
        "Nechta telefon olib kirish mumkin": "Jismoniy shaxslar uchun telefon apparati odatda 6 kalendar oyda 1 dona miqdoriy norma bilan qo‘llanadi avtoyo‘l, piyoda, temir yo‘l va daryo punktlari orqali. Agar ko‘p bo‘lsa, bu tijorat importi deb baholanishi mumkin.",
...
VED_POSTS = [
  {
    ...
    "code": "102",
    "name": "\"Авиа юклар\" ТИФ",
    "location": "Тошкент, шаҳар, Сирғали тумани, \"Ислом Каримов номидаги “Тошкент” халқаро аэропорти\" худудида",
    "phone": "+99855 502-86-43"
  },
  {
    "num": 2,
    "code": "3011",
    "name": "\"Андижон\" ТИФ",
    "location": "Андижон шаҳар, АЮлдашев кўчаси, 55 уй",
    "phone": "998742247615 (6570,6571,6572,6573)"
  },
  {
    "num": 3,
    "code": "3015",
    "name": "\"Асака\" ТИФ",
    "location": "Андижон вилояти, Асака шаҳар, ЖМангуберди кўчаси, 36 “а”- уй",
    "phone": "998742247615 (6580,6581,6582,6583, 6584)"
  },
  {
    "num": 4,
    "code": "6006",
    "name": "\"Бухоро\" ТИФ",
    "location": "Бухоро вилояти, Бухоро шахар, Саноатчилар кўчаси 2 уй",
    "phone": "998 65 225 38 30"
  },
  {
    "num": 5,
    "code": "6009",
    "name": "\"Қоракўл\" ТИФ",
    "location": "Бухоро вилояти, Қоракўл туман. Бухоро кўчаси 9-уй",
    "phone": "998 95 600 99 50"
  },
  {
    "num": 6,
    "code": "8004",
    "name": "\"Жизах\" ТИФ",
    "location": "Жиззах вилояти, Жиззах шаҳар, \"А\" саноат худуди, 10 уй",
    "phone": ""
  },
  {
    "num": 7,
    "code": "10002",
    "name": "\"Насаф\" ТИФ",
    "location": "Қашқадарё вилояти Қарши шахар Ёг завод кучаси 2 уй",
    "phone": ""
  },
  {
    "num": 8,
    "code": "10007",
    "name": "\"Қамаши-Ғузор\" ТИФ",
    "location": "Қашқадарё вилояти, Ғузор тумани, А-380 йўли яқинида, Шўртан қўрғони",
    "phone": "998752211418(8524,8527)"
  },
  {
    "num": 9,
    "code": "12003",
    "name": "\"Навоий\" ТИФ",
    "location": "Навоий вилояти, Навоий шаҳар, Навоий кўчаси 5-уй",
    "phone": "+998(79)-229-28-00"
  },
  {
    "num": 10,
    "code": "12008",
    "name": "\"Зарафшон\" ТИФ",
    "location": "Навоий вилояти, Зарафшон шаҳар, шаҳарга кириш ҳудуди",
    "phone": "+998(79)-573-43-68"
  },
  {
    "num": 11,
    "code": "14010",
    "name": "\"Наманган\" ТИФ",
    "location": "Namangan viloyati, Namangan shahri, Yuqori Rovuston ko`chasi.",
    "phone": "998692267600 (6971, 6972)"
  },
  {
    "num": 13,
    "code": "18005",
    "name": "\"Самарқанд\" ТИФ",
    "location": "Самарқанд вилояти, Самарканд тумани Ўзбеккент маҳалласи",
    "phone": "-"
  },
  {
    "num": 14,
    "code": "18007",
    "name": "\"Улуғбек\" ТИФ",
    "location": "Самарқанд вилояти, Пастдарғом тумани Чархин қўрғони",
    "phone": ""
  },
  {
    "num": 15,
    "code": "22005",
    "name": "\"Термиз\" ТИФ",
    "location": "Сурхондарё вилояти, Термиз тумани, Айритом махалласи",
    "phone": ""
  },
  {
    "num": 16,
    "code": "22006",
    "name": "\"Денов\" ТИФ",
    "location": "Сурхондарё вилояти, Денов шахри, Фаррухий кўчаси 2 уй",
    "phone": ""
  },
  {
    "num": 17,
    "code": "24009",
    "name": "\"Гулистон\" ТИФ",
    "location": "Сирдарё вилояти, Гулистон шахри, Аноров кўчаси 1-уй",
    "phone": "ички номер (6787; 6788)"
  },
  {
    "num": 18,
    "code": "26002",
    "name": "\"Тошкент-товар\" ТИФ",
    "location": "Тошкент шаҳар, Яшнобод тумани, Фарғона йўли кўчаси, 13/11-уй",
    "phone": "71-207-09-72"
  },
  {
    "num": 19,
    "code": "26003",
    "name": "\"Арқбулоқ\" ТИФ",
    "location": "Тошкент вилояти, Зангиота тумани, Эркин ҚФЙ, Тариқ тешар маҳалласи",
    "phone": "71-207-09-40"
  },
  {
    "num": 20,
    "code": "26004",
    "name": "\"Чуқурсой\" ТИФ",
    "location": "Тошкент шаҳар, Олмазор тумани, Чуқурсой кўчаси 92Б уй",
    "phone": "71-207-09-74"
  },
  {
    "num": 21,
    "code": "26010",
    "name": "\"Сирғали\" ТИФ божхона пости",
    "location": "Тошкент шаҳар, Сирғали тумани, Суғдиёна кўчаси 3-уй",
    "phone": "71-207-08-52"
  },
  {
    "num": 22,
    "code": "27014",
    "name": "\"Чирчиқ\" ТИФ",
    "location": "Тошкент вилояти, Чирчиқ шаҳри, Рамазон кўчаси 52 уй",
    "phone": "99871-202-07-61"
  },
  {
    "num": 23,
    "code": "27015",
    "name": "\"Олмалиқ\" ТИФ",
    "location": "Тошкент вилояти, Олмалиқ шаҳар, Фахрийлар кўчаси, 29 уй",
    "phone": "99871-202-02-80"
  },
  {
    "num": 24,
    "code": "27016",
    "name": "\"Янгийўл\" ТИФ",
    "location": "Тошкент вилояти, Зангиота тумани, Ўртаоул МФЙ, Файз маҳалласи",
    "phone": "99871-202-02-82"
  },
  {
    "num": 25,
    "code": "27019",
    "name": "\"Назарбек\" ТИФ",
    "location": "Тошкент вилояти, Зангиота тум., Назарбек қфй, Лойихачи кўча 11",
    "phone": "99878-150-88-56"
  },
  {
    "num": 26,
    "code": "27020",
    "name": "\"Келес\" ТИФ",
    "location": "Тошкент вилояти, Тошкент тум., Оқибат кўчаси 140 уй",
    "phone": "99871-202-02-77"
  },
  {
    "num": 27,
    "code": "27028",
    "name": "\"Ангрен\" ТИФ",
    "location": "Тошкент вилояти, Ангрен шаҳри, Саноат ҳудуди, Ипак-йўли кўчаси 1 уй,",
    "phone": ""
  },
  {
    "num": 28,
    "code": "30002",
    "name": "\"Қўқон\" ТИФ",
    "location": "Фарғона вилояти, Қўқон шаҳар, Шохрухобод кўчаси 2-уй",
    "phone": ""
  },
  {
    "num": 29,
    "code": "30009",
    "name": "\"Водий\" ТИФ",
    "location": "Фарғона вилояти, Фарғона шаҳар, Ёруғлик кўчаси 19-уй",
    "phone": ""
  },
  {
    "num": 30,
    "code": "33007",
    "name": "\"Урганч\" ТИФ",
    "location": "Хоразм вилояти, Урганч шаҳар “Хонқа” кўчаси 62/1-уй",
    "phone": ""
  },
  {
    "num": 31,
    "code": "35002",
    "name": "\"Нукус\" ТИФ",
    "location": "Нукус шаҳри, Қиз кеткен МФЙ Жанубий саноат зонаси рақамсиз уй (“Умид Нукус” МЧЖ маъмурий биносида)",
    "phone": "+998 (61) 224-95-59"
  },
  {
    "num": 32,
    "code": "107",
    "name": "\"Бош почтампт\" ТИФ",
    "location": "Тошкент шаҳар, Сирғали тумани, Қумариқ кўчаси 102-уй",
    "phone": "71-207-14-03"
  },
  {
    "num": 33,
    "code": "22022",
    "name": "“Термиз халқаро савдо маркази” ТИФ божхона пости",
    "location": "Сурхондарё вилояти, Термиз тумани, \"Айритом\" МФЙ",
    "phone": "998762299595, (8895)"
  }
]
BORDER_POSTS = [
  {
    ...
    "location": "Тошкент шаҳар, Сирғали тумани, \"Ислом Каримов номидаги “Тошкент” халқаро аэропорти\" Терминал 2",
  ...
  },
  {
    ...
    "location": "Андижон вилояти, Хўжаобод тумани, “Манак” ҚФЙ “Дўстлик” МФЙ",
  ...
  },
  {
    ...
    "code": "3003",
    "name": "\"Андижан АЭРОи\"",
    "location": "Андижон шаҳар, Янги айланма кўчаси, 1 уй",
  ...
  },
  {
    ...
    "location": "Андижон вилояти, Пахтаобод тумани, Маданият ҚФЙ Тошқўрғон МФЙ",
  ...
  },
  {
    ...
    "location": "Андижон вилояти, Қўрғонтепа тумани, Устоз МФЙ, Бирлик кўча 1 уй",
  ...
  },
  {
    ...
    "code": "6001",
    "name": "\"Бухоро АЭРОи\"",
    "location": "Бухоро вилояти, Бухоро шаҳри, Б.Нақшбанд кўчаси, 251-уй",
  ...
  },
  {
    ...
    "location": "Бухоро вилояти, Олот тумани, Союн Қоровул МФЙ, Олот чегара божхона пости",
  ...
  },
  {
    ...
    "location": "Бухоро вилояти, Олот тумани, Союн қоровул МФЙ, Хўжадавлат темир йўл станцияси",
  ...
  },
  {
    ...
    "location": "Жиззах вилояти, Янгиобод тумани, Учтўрғон ахоли пункти, Тошкент-Душанбе М-34 магистрал йўли",
    "phone": ""
  },
  {
    "num": 10,
    ...
    "location": "Жиззах вилояти, Янгиобод тумани, Қўшкент ахоли пункти, Тошкент-Душанбе М-34 магистрал йўли",
    "phone": ""
  },
  {
    "num": 11,
    ...
    "location": "Қашқадарё вилояти Нишон тумани",
  ...
  },
  {
    ...
    "code": "10012",
    "name": "\"Қарши АЭРОи\"",
    "location": "Қашқадарё вилояти Қарши шахар Буюк турон кўчаси 3 уй",
    "phone": ""
  },
  {
    "num": 13,
    "code": "12002",
    "name": "\"Навоий АЭРОи\"",
    "location": "Навоий вилояти, Кармана тумани, Сардоба маҳалласи, \"Навоий халқаро аэропорти\" МЧЖ ҳудуди",
  ...
  },
  {
    ...
    "code": "14002",
    "name": "\"Наманган АЭРОи\"",
    "location": "Namangan viloyati, Namangan shahri, Namangan aeroporti",
    "phone": ""
  },
  {
    "num": 15,
    ...
    "location": "Namangan viloyati, Uchqo`rg`on tumani, Yangiyer QFY, Bo`ston MFY",
    "phone": ""
  },
  {
    "num": 16,
    ...
    "location": "Namangan viloyati, Kosonsoy tumani, Obod MFY",
    "phone": ""
  },
  {
    "num": 17,
    ...
    "location": "Namangan viloyati, Pop tumani, Pungon qishlog`I",
    "phone": ""
  },
  {
    "num": 18,
    ...
    "location": "Самарқанд вилояти, Самарқанд шаҳри Ибн Сино кўчаси 1-уй",
    "phone": ""
  },
  {
    "num": 19,
    ...
    "location": "Самарқанд вилояти, Ургут тумани Жартепа қишлоғи",
    "phone": "-"
  },
  {
    "num": 20,
    "code": "22002",
    "name": "\"Термиз АЭРОи\"",
    "location": "Сурхондарё вилояти, Термиз тумани, “Дўстлик” жамоа хужалиги",
    "phone": ""
  },
  {
    "num": 21,
    ...
    "location": "Сурхондарё вилояти, Сариосиё тумани \"Суфиён\" ж/х, \"Чумчукли жар\" поселкаси",
    "phone": ""
  },
  {
    "num": 22,
    ...
    "location": "Сурхондарё вилояти, Узун тумани, Хатиб Қахрамон МФЙ Қўрғон қишлоғи",
    "phone": ""
  },
  {
    "num": 23,
    ...
    "location": "Сурхондарё вилояти, Термиз тумани Гулбаҳор махалласи",
    "phone": ""
  },
  {
    "num": 24,
    ...
    "location": "Сурхондарё вилояти, Термиз шахри, С.Термизий кучаси 58 уй",
    "phone": ""
  },
  {
    "num": 25,
    ...
    "location": "Сурхондарё вилояти Музрабод тумани, Чегарачи МФЙ Қоракамар қишлоги",
    "phone": ""
  },
  {
    "num": 26,
    ...
    "location": "Сурхондарё вилояти, Термиз тумани, “Янгиарик” СФУ",
    "phone": ""
  },
  {
    "num": 27,
    ...
    "location": "Сирдарё вилояти, Ховос тумани, Ховос қўрғони Карвонсарой маҳалласи",
  ...
  },
  {
    ...
    "location": "Сирдарё вилояти, Сирдарё тумани, Синдоробод СИУ, Қуёш махалласи, Р-35 “Сирдарё-Илъич” автойўлининг 12-км.да",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Тошкент тумани, Оқибат кўчаси 12-уй",
    "phone": ""
  },
  {
    "num": 30,
    ...
    "location": "Тошкент шаҳри, Олмазор тумани, Чуқурсой кўчаси, 82 уй",
    "phone": "71-207-09-56"
  },
  {
    "num": 31,
    ...
    "location": "Тошкент вилояти, Чиноз тумани, Яллама қишлоғи",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Тошкент тумани, Чувалачи ҚФЙ, “Гултепа” МФЙ",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Қибрай тумани, Май қишлоғи Туркистон ҚФЙ",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Бекобод тумани, Ойбек ж/х",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Бекобод тумани",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Тошкент тумани Ғишткўприк махалласи, Чимкент йўли кўчаси",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Бекобод шаҳри, Сохил йўли, Низомий кўчаси",
    "phone": "99871-202-02-74"
  },
  {
    "num": 38,
    ...
    "location": "Тошкент вилояти, Бекобод шаҳри, Бекобод темир йўл станцияси",
  ...
  },
  {
    ...
    "location": "Тошкент вилояти, Янгийўл тумани, Ўзбекистон темир йўл станцияси",
    "phone": ""
  },
  {
    "num": 40,
    ...
    "location": "Фарғона вилояти, Фарғона шаҳар, Аэропорт кўчаси 16-уй",
    "phone": ""
  },
  {
    "num": 41,
    "code": "30004",
    "name": "\"Фарғона\" чегара пости",
    "location": "Фарғона вилояти, Фарғона тумани, Юқори Водил қишлоғи, Яхши Ният кўчаси",
    "phone": ""
  },
  {
    "num": 42,
    ...
    "location": "Фарғона вилояти, Бешариқ тумани, Андархон қишлоғи",
    "phone": ""
  },
  {
    "num": 43,
    ...
    "location": "Фарғона вилояти, Риштон тумани, Риштон шахри, Хўжа Илғор МФЙ, Фарғона кўчаси",
    "phone": ""
  },
  {
    "num": 44,
    ...
    "location": "Фарғона вилояти Бешариқ тумани Қашқар ҚФЙ, Воррух қишлоғи",
    "phone": ""
  },
  {
    "num": 45,
    ...
    "location": "Фарғона вилояти, Қувасой шаҳар, Носиробод қишлоғи, Ўзбекистон кўчаси",
    "phone": ""
  },
  {
    "num": 46,
    ...
    "location": "Фарғона вилояти, Сўх тумани, Ровон шаҳарчаси, Амир Темур кўчаси, 4Р-149 рақамли автойўлда",
    "phone": ""
  },
  {
    "num": 47,
    ...
    "location": "Хоразм вилояти, Шовот тумани, Ўзбекистон қишлоғи, Махтумқули маҳалласи",
    "phone": ""
  },
  {
    "num": 48,
    ...
    "location": "Хоразм вилояти, Тупроққалъа тумани, Питнак шаҳри, Питнак қишлоғи, Охунбобоев маҳалласи",
    "phone": ""
  },
  {
    "num": 49,
    "code": "33011",
    "name": "\"Урганч АЭРОи\"",
    "location": "Хоразм вилояти, Урганч шаҳри, Урганч халқаро аэропорти",
    "phone": ""
  },
  {
    "num": 50,
    "code": "35001",
    "name": "\"Нукус АЭРОи\"",
    "location": "Нукус шаҳри, А.Досназаров кўчаси",
  ...
  },
  {
    ...
    "location": "Хўжайли тумани, “Ходжейли-Куня Ургенч” авто йўли",
  ...
  },
  {
    ...
    "location": "Қўнғирот тумани, А-380 “Гузар-Бухара-Нукус-Бейнеу” автомагистралининг 1204 км",
  ...
  },
  {
    ...
    "location": "Қўнғирот тумани, “Қорақалпоғистон” поселкаси, “ Қорақалпоғистон ” темир йўл станцияси",
  ...
  },
  {
    ...
    "location": "Андижон вилояти, Хонобод тумани,“Навоий” МФЙ",
  ...
  },
  {
    ...
    "location": "Андижон вилояти, Мархамат тумани, “Қорабоғич” ҚФЙ “Дўстлик” МФЙ",
    "phone": "998952014328, 998742247615 (6410,6441)"
  },
  {
    "num": 56,
    ...
    "location": "Андижон вилояти, Қўрғонтепа тумани, Қорасув шаҳар",
    "phone": ""
  },
  {
    "num": 57,
    ...
    "location": "Андижон вилояти, Пахтабод тумани Уйғур ҚФЙ, Пушмон махалла",
    "phone": ""
  },
  {
    "num": 58,
    ...
    "location": "Андижон вилояти, Қўрғонтепа тумани, Султонобод қишлоғи",
    "phone": ""
  },
  {
    "num": 59,
    ...
    "location": "Сирдарё вилояти, Сирдарё тумани, Пахтакор СИУ, М39 автойўлининг 888 км.да",
  ...
  },
  {
    ...
    "location": "Сирдарё вилояти, Оқ олтин тумани, Сардоба қўрғони, М39 автойўлининг 912 км.да",
  ...
  },
  {
    ...
    "location": "Тошкент шаҳар, Яшнобод тумани, \"Тошкент-хумо\" халқаро аэропорти",
...
def format_posts_list(posts, lang):
    title = "📦 ВЭД посты" if lang == "ru" else "📦 VED postlari"
    if posts is BORDER_POSTS:
        title = "🚧 Пограничные посты" if lang == "ru" else "🚧 Chegara postlari"

    parts = [f"<b>{title}</b>", ""]
    for p in posts:
        parts.append(f"{p['num']}. {p['name']}")
    parts.append("")
    parts.append("Введите номер поста, чтобы увидеть подробную информацию." if lang == "ru" else "Batafsil ma’lumot uchun post raqamini yuboring.")
    return "\n".join(parts).strip()

def format_post_detail(post, lang):
    parts = [f"<b>{post['num']}. {post['name']}</b>"]
    if post.get("code"):
        parts.append(("Код поста: " if lang == "ru" else "Post kodi: ") + str(post["code"]))
    if post.get("location"):
        parts.append(("Локация: " if lang == "ru" else "Joylashuv: ") + str(post["location"]))
    if post.get("phone"):
        parts.append(("Контакт: " if lang == "ru" else "Kontakt: ") + str(post["phone"]))
    if post.get("latitude") and post.get("longitude"):
        parts.append("📍 Локация доступна — нажмите кнопку ниже." if lang == "ru" else "📍 Lokatsiya mavjud — quyidagi tugmani bosing.")
    else:
        parts.append("📍 Геопозиция пока не добавлена." if lang == "ru" else "📍 Geolokatsiya hali qo‘shilmagan.")
    return "\n".join(parts)

def post_detail_kb(lang: str):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    kb.add("📍 Локация" if lang == "ru" else "📍 Lokatsiya")
    kb.add(t(lang, "back"), t(lang, "back_menu"))
    return kb

def get_post_by_num(posts, num_text):
    try:
        num = int(str(num_text).strip())
    except Exception:
        return None
    for p in posts:
        if int(p.get("num", -1)) == num:
            return p
    return None
...
def ctx(uid: int) -> Dict[str, Any]:
    if uid not in USER_CTX:
        USER_CTX[uid] = {"lang":"ru","role":None,"mode":None,"category":None,"group":None,"pending_form":None,"form_data":{},"posts_kind":None,"selected_post":None}
    return USER_CTX[uid]
...
def physical_menu(lang: str):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    kb.add("🤖 AI bojxonachi" if lang == "uz" else "🤖 AI таможенник")
    kb.add("🏢 Bojxona postlari ro‘yxati" if lang == "uz" else "🏢 Список таможенных постов")
    kb.add(t(lang, "specialist"))
    kb.add(t(lang, "change"))
    return kb

def physical_ai_menu(lang: str):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    kb.add("📋 Tayyor savollar" if lang == "uz" else "📋 Готовые вопросы")
    kb.add("✍️ O‘z savolingiz" if lang == "uz" else "✍️ Свой вопрос")
    kb.add(t(lang, "back"), t(lang, "specialist"))
    kb.add(t(lang, "back_menu"))
    return kb

def physical_ready_q_kb(lang: str):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    if lang == "uz":
        kb.add("Jismoniy shaxslar uchun bojxona qoidalari")
        kb.add("Bojsiz qancha olib kirish mumkin")
        kb.add("Nechta telefon olib kirish mumkin")
        kb.add("Dori olib kirish mumkinmi")
        kb.add("Qancha valyuta olib chiqish mumkin")
        kb.add("Norma oshsa nima bo‘ladi")
    else:
        kb.add("Таможенные правила для физлиц")
        kb.add("Сколько можно ввозить без пошлины")
        kb.add("Сколько телефонов можно привезти")
        kb.add("Можно ли ввозить лекарства")
        kb.add("Сколько можно вывозить валюты")
        kb.add("Что будет при превышении нормы")
    kb.add(t(lang, "back"), t(lang, "specialist"))
    kb.add(t(lang, "back_menu"))
    return kb

def physical_posts_menu(lang: str):
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    kb.add("🚧 Chegara postlari" if lang == "uz" else "🚧 Пограничные посты")
    kb.add("📦 VED postlari" if lang == "uz" else "📦 ВЭД посты")
    kb.add(t(lang, "back"), t(lang, "back_menu"))
    return kb
...
async def ask_physical_ai(question: str, lang: str) -> str:
    if client:
        try:
            prompt = (
                f"Ответь кратко на {'русском' if lang=='ru' else 'узбекском'} языке как AI таможенник для физических лиц Узбекистана. "
                f"Используй в первую очередь этот контекст: {PHYSICAL_CUSTOMS_CONTEXT}. "
                f"Отвечай только по таможенным вопросам. Если точного ответа нет, прямо скажи, что нужна дополнительная проверка и предложи помощь специалиста. "
                f"В конце всегда добавь короткую фразу о помощи специалиста. Вопрос: {question}"
            )
            resp = client.responses.create(model=OPENAI_MODEL, input=prompt)
            ...
            pass
    base = physical_answer(question, lang)
    extra = "Точную информацию по вашему кейсу можно получить бесплатно через специалиста." if lang == "ru" else "Aniq ma’lumotni mutaxassis orqali bepul olishingiz mumkin."
    return base + "\n\n" + extra
...
async def send_role_menu(message: types.Message, uid: int):
    ...
    if role == "physical":
        await message.answer("Выберите раздел:" if lang == "ru" else "Bo‘limni tanlang:", reply_markup=physical_menu(lang))
    elif role == "legal":
...
async def router(message: types.Message):
    ...
    if text == t(lang, "back"):
        if c["role"] == "physical" and c["mode"] in ["physical_ai_menu","physical_chat","physical_ready_questions","physical_posts_menu"]:
            await message.answer("Главное меню:" if lang == "ru" else "Asosiy menyu:", reply_markup=physical_menu(lang))
            c["mode"] = None
            return
    ...
    if role == "physical":
        if text in ["🤖 AI таможенник", "🤖 AI bojxonachi"]:
            reset_mode(uid); c["mode"] = "physical_ai_menu"
            title = "🤖 <b>AI таможенник</b>\n\nВыберите формат:" if lang == "ru" else "🤖 <b>AI bojxonachi</b>\n\nFormatni tanlang:"
            await message.answer(title, reply_markup=physical_ai_menu(lang)); return
        if text in ["📋 Готовые вопросы", "📋 Tayyor savollar"]:
            reset_mode(uid); c["mode"] = "physical_ready_questions"
            await message.answer("Выберите готовый вопрос:" if lang == "ru" else "Tayyor savolni tanlang:", reply_markup=physical_ready_q_kb(lang)); return
        if text in ["✍️ Свой вопрос", "✍️ O‘z savolingiz"]:
            reset_mode(uid); c["mode"] = "physical_chat"
            intro = "Напишите любой вопрос по таможенным правилам для физических лиц в Узбекистане." if lang == "ru" else "O‘zbekistonda jismoniy shaxslar uchun bojxona qoidalari bo‘yicha savolingizni yozing."
            await message.answer(intro, reply_markup=physical_ai_menu(lang)); return
        if text in ["🏢 Список таможенных постов", "🏢 Bojxona postlari ro‘yxati"]:
            reset_mode(uid); c["mode"] = "physical_posts_menu"
            await message.answer("Выберите тип постов:" if lang == "ru" else "Post turini tanlang:", reply_markup=physical_posts_menu(lang)); return
        if text in ["🚧 Пограничные посты", "🚧 Chegara postlari"]:
            reset_mode(uid); c["mode"] = "physical_posts_border"; c["posts_kind"] = "border"
            await send_safe_message(message, format_posts_list(BORDER_POSTS, lang), reply_markup=physical_posts_menu(lang)); return
        if text in ["📦 ВЭД посты", "📦 VED postlari"]:
            reset_mode(uid); c["mode"] = "physical_posts_ved"; c["posts_kind"] = "ved"
            await send_safe_message(message, format_posts_list(VED_POSTS, lang), reply_markup=physical_posts_menu(lang)); return
        if c.get("mode") in ["physical_posts_border", "physical_posts_ved"] and text.isdigit():
            posts = BORDER_POSTS if c.get("posts_kind") == "border" else VED_POSTS
            post = get_post_by_num(posts, text)
            if not post:
                await message.answer("Пост с таким номером не найден." if lang == "ru" else "Bunday raqamli post topilmadi.", reply_markup=physical_posts_menu(lang)); return
            c["selected_post"] = post
            c["mode"] = "physical_post_detail"
            await message.answer(format_post_detail(post, lang), reply_markup=post_detail_kb(lang)); return
        if text in ["📍 Локация", "📍 Lokatsiya"]:
            post = c.get("selected_post")
            if not post:
                await message.answer("Сначала выберите пост из списка." if lang == "ru" else "Avval ro‘yxatdan postni tanlang."); return
            lat = post.get("latitude"); lon = post.get("longitude")
            if lat and lon:
                await bot.send_location(message.chat.id, latitude=float(lat), longitude=float(lon))
                await message.answer("Геолокация отправлена." if lang == "ru" else "Geolokatsiya yuborildi.", reply_markup=post_detail_kb(lang)); return
            await message.answer("Для этого поста геолокация пока не добавлена." if lang == "ru" else "Bu post uchun geolokatsiya hali qo‘shilmagan.", reply_markup=post_detail_kb(lang)); return
        ready_answers = PHYSICAL_READY_ANSWERS["ru" if lang == "ru" else "uz"]
        if text in ready_answers:
            ans = ready_answers[text] + ("\n\nЕсли хотите, задайте ещё вопрос по вашей ситуации или нажмите «Специалист»." if lang == "ru" else "\n\nXohlasangiz, holatingiz bo‘yicha yana savol bering yoki «Mutaxassis» tugmasini bosing.")
            await message.answer(ans, reply_markup=physical_ready_q_kb(lang)); return
        if text in [t(lang, "tnved"), t(lang, "exact"), t(lang, "broker_cost"), t(lang, "faq"), t(lang, "docs"), t(lang, "chat")]:
            await message.answer("Для физлиц используйте разделы AI таможенник, Список таможенных постов или Специалист." if lang == "ru" else "Jismoniy shaxslar uchun AI bojxonachi, Bojxona postlari ro‘yxati yoki Mutaxassis bo‘limidan foydalaning.", reply_markup=physical_menu(lang)); return
    ...
    if c["mode"] == "physical_chat":
        ans = await ask_physical_ai(text, lang)
        await message.answer(ans, reply_markup=physical_ai_menu(lang))
        return
