...
TXT = {
    ...
    "uz": {
        ...
        "faq_3":"TN VED kodi nima?",
        "faq_4":"Bojlar nimadan hisoblanadi?",
        "faq_5":"Qanday sertifikatlar kerak bo‘lishi mumkin?",
        "faq_6":"Tovar kodini qanday aniqlash mumkin?",
...
def faq_answer(text: str, lang: str) -> str:
    ...
    if text == t(lang, "faq_3"):
        return (
            ...
            if lang == "ru" else
            "TN VED kodi — tashqi iqtisodiy faoliyat tovar nomenklaturasi kodi.\nU orqali aniqlanadi:\n• boj\n• QQS\n• aksiz\n• sertifikat talablari\n• cheklov va ruxsatlar\n\nSizga aniq bir tovar uchun kod kerakmi?"
        )
    if text == t(lang, "faq_4"):
        return (
            ...
            if lang == "ru" else
            "Bojlar odatda tovarning bojxona qiymatidan hisoblanadi.\nQo‘shimcha ravishda qo‘llanishi mumkin:\n• QQS\n• aksiz\n• util yig‘imi\n• maxsus yig‘imlar\n\nAniq tovar bo‘yicha hisob-kitob kerakmi?"
        )
    if text == t(lang, "faq_5"):
        return (
            "В зависимости от товара могут понадобиться:\n• сертификат соответствия\n• санитарно-эпидемиологическое заключение\n• разрешительные документы\n• декларация соответствия\n\nУточните, пожалуйста: о каком товаре идёт речь?"
            if lang == "ru" else
            "Tovarga qarab quyidagilar kerak bo‘lishi mumkin:\n• muvofiqlik sertifikati\n• sanitariya-epidemiologik xulosa\n• ruxsatnoma\n• muvofiqlik deklaratsiyasi\n\nIltimos, qaysi tovar haqida gap ketayotganini yozing?"
        )
    if text == t(lang, "faq_6"):
        return (
            "Код товара определяется по его назначению, составу, материалу, характеристикам и правилам классификации.\n\nУточните, пожалуйста: какой именно товар нужно определить?"
            if lang == "ru" else
            "Tovar kodi uning vazifasi, tarkibi, materiali, xususiyatlari va tasniflash qoidalari bo‘yicha aniqlanadi.\n\nQaysi tovar uchun kod aniqlash kerak?"
        )
    return ""
