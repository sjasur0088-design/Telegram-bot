...
def build_physical_ai_prompt(user_text: str, c: Dict[str, Any], lang: str) -> str:
    ...
    if lang == "uz":
        ...
        base = (
            ...
            "Отвечай очень коротко: 2-4 предложения. Сначала дай прямое правило и цифры. Потом коротко применяй это к примеру пользователя. В конце, если есть неопределенность, добавь одну фразу про специалиста. Не уходи в длинные объяснения."
        )
