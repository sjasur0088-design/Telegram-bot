...
from physical_context import get_physical_context, save_physical_context, clear_physical_context
...
PHYSICAL_KNOWLEDGE_PATH = os.path.join(BASE_DIR, "physical_knowledge_pro.json")
try:
